...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Sobre',
        aboutFooter: 'Happy Coder é um cliente móvel para Claude Code. É totalmente criptografado ponta a ponta e sua conta é armazenada apenas no seu dispositivo. Não é afiliado à Anthropic.',
        whatsNew: 'Novidades',
    ...
    agentInput: {
        ...
        codexModel: {
            ...
            gpt5MinimalDesc: 'Respostas mais rápidas com raciocínio limitado',
            gpt5Low: 'GPT-5 Baixo',
            gpt5LowDesc: 'Equilibra velocidade com algum raciocínio',
            gpt5Medium: 'GPT-5 Médio',
            gpt5MediumDesc: 'Equilíbrio padrão entre raciocínio e latência',
            gpt5High: 'GPT-5 Alto',
            gpt5HighDesc: 'Maximiza a profundidade do raciocínio',
        },
        context: {
    ...
    welcome: {
        ...
        title: 'Cliente móvel Claude Code',
