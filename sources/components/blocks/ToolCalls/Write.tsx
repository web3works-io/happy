      ...
      <View className="bg-gray-50 border-y border-gray-200 flex-1">
        ...
        {contentAnalysis && (
          <View className="flex-1 bg-white">
            <DiffViewerWebView
              oldValue={isNewFile ? '' : '// Previous content not available'}
              newValue={String(contentAnalysis.content)}
              splitView={false}
              leftTitle={isNewFile ? 'Empty File' : 'Previous Content'}
              rightTitle={isNewFile ? 'New Content' : 'Updated Content'}
              height={400}
            />
          </View>
        )}
